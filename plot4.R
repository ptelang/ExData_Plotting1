...
actpower <- as.numeric(subSetData$Global_active_power)
reactpower <- as.numeric(subSetData$Global_reactive_power)
...
plot(datetime, actpower, type="l", xlab="", ylab="Global Active Power", cex=0.2)
